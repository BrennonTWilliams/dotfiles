...
description: Researches current web information, documentation, and resources beyond training data. Use for recent releases, library docs, API references, best practices, or fact-checking from authoritative sources. Re-run with an altered prompt if initial results are insufficient.
tools: WebSearch, WebFetch, Bash, Read, Grep, Glob, LS
color: yellow
model: sonnet
---
